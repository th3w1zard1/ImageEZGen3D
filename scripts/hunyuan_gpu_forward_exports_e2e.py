...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Attempt Hunyuan GPU forward E2E with G6 export finalization. "
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Run directory for artifacts (default: temp dir).",
    )
    ...
    if run_dir is None:
        temp_dir = tempfile.TemporaryDirectory(prefix="hunyuan-gpu-forward-exports-e2e-")
